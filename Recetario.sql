...
-- -----------------------------------------------------
-- Table `Recetario`.`grupos`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `Recetario`.`grupos` ;

CREATE TABLE IF NOT EXISTS `Recetario`.`grupos` (
  `idGrupos` INT NOT NULL,
  `nombre` VARCHAR(50) NOT NULL,
  `titularG` INT NOT NULL,
  PRIMARY KEY (`idGrupos`),
  INDEX `fk_Grupos_usuarios1_idx` (`titularG` ASC) ,
  CONSTRAINT `fk_Grupos_usuarios1`
    FOREIGN KEY (`titularG`)
    REFERENCES `Recetario`.`usuarios` (`idusuarios`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `Recetario`.`recetas del grupo`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `Recetario`.`recetas del grupo` ;

CREATE TABLE IF NOT EXISTS `Recetario`.`recetas del grupo` (
  `Grupos_idGrupos` INT NOT NULL,
  `recetas_idrecetas` INT NOT NULL,
  `recetas_creador` INT NOT NULL,
  PRIMARY KEY (`Grupos_idGrupos`, `recetas_idrecetas`, `recetas_creador`),
  INDEX `fk_Grupos_has_recetas_recetas1_idx` (`recetas_idrecetas` ASC, `recetas_creador` ASC) ,
  INDEX `fk_Grupos_has_recetas_Grupos1_idx` (`Grupos_idGrupos` ASC) ,
  CONSTRAINT `fk_Grupos_has_recetas_Grupos1`
    FOREIGN KEY (`Grupos_idGrupos`)
    REFERENCES `Recetario`.`grupos` (`idGrupos`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `fk_Grupos_has_recetas_recetas1`
    FOREIGN KEY (`recetas_idrecetas` , `recetas_creador`)
    REFERENCES `Recetario`.`recetas` (`idrecetas` , `creador`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
...
-- -----------------------------------------------------
-- Table `Recetario`.`miembrosGrupo`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `Recetario`.`miembrosGrupo` ;

CREATE TABLE IF NOT EXISTS `Recetario`.`miembrosGrupo` (
  `grupos_idGrupos` INT NOT NULL,
  `usuarios_idusuarios` INT NOT NULL,
  PRIMARY KEY (`grupos_idGrupos`, `usuarios_idusuarios`),
  INDEX `fk_grupos_has_usuarios_usuarios1_idx` (`usuarios_idusuarios` ASC) ,
  INDEX `fk_grupos_has_usuarios_grupos1_idx` (`grupos_idGrupos` ASC) ,
